...
import com.slickreader.fragment.FolderListFragment;
import com.slickreader.fragment.LogoutDialogFragment;
...
public class Main extends NbFragmentActivity implements StateChangedListener, SyncUpdateFragment.SyncUpdateFragmentInterface {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (syncFragment == null) {
            ...
            // so the UI appears more quickly (per the docs at slickreader.com/api)
			triggerFirstSync();
		}
	}
