package com.slickreader.service;
...
import com.slickreader.network.APIClient;
import com.slickreader.network.APIConstants;
...
public class SyncService extends IntentService {
	...
	protected void onHandleIntent(Intent intent) {
		...
		try {
			...
			e.printStackTrace();
			Log.e(this.getClass().getName(), "Couldn't synchronise with SlickReader servers: " + e.getMessage(), e.getCause());
			if (receiver != null) {
