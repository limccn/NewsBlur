...
import com.slickreader.domain.Comment;
import com.slickreader.domain.Feed;
import com.slickreader.domain.FeedResult;
import com.slickreader.domain.Folder;
import com.slickreader.domain.Reply;
import com.slickreader.domain.SocialFeed;
import com.slickreader.domain.Story;
import com.slickreader.domain.UserProfile;
import com.slickreader.domain.ValueMultimap;
import com.slickreader.network.domain.CategoriesResponse;
import com.slickreader.network.domain.FeedFolderResponse;
import com.slickreader.network.domain.FeedRefreshResponse;
import com.slickreader.network.domain.LoginResponse;
import com.slickreader.network.domain.Message;
import com.slickreader.network.domain.ProfileResponse;
import com.slickreader.network.domain.SocialFeedResponse;
import com.slickreader.network.domain.StoriesResponse;
import com.slickreader.serialization.BooleanTypeAdapter;
import com.slickreader.serialization.DateStringTypeAdapter;
...
public class APIManager {
	...
	public LoginResponse signup(final String username, final String password, final String email) {
		...
		if (response.responseCode == HttpStatus.SC_OK && !response.hasRedirected) {
			...
			cookieManager.setCookie(".slickreader.com", response.cookie);
