...
- (void)viewWillAppear:(BOOL)animated {
    ...
    NSString *urlAddress = [NSString stringWithFormat:@"https://%@%@", NEWSBLUR_URL, url];
...
- (BOOL)webView:(UIWebView *)webView shouldStartLoadWithRequest:(NSURLRequest *)request navigationType:(UIWebViewNavigationType)navigationType {
    ...
    if ([URLString isEqualToString:[NSString stringWithFormat:@"https://%@/", NEWSBLUR_URL]]) {
...
//    if ([URLString hasPrefix:[NSString stringWithFormat:@"https://%@/import/callback", NEWSBLUR_URL]]) {
//        [self.navigationController popViewControllerAnimated:YES];
